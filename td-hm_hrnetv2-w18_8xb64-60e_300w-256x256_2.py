...
dataset_vali = dict( 
    ...
    # ann_file='annotations/300VW_blur_label_list_256_train_mmpose.json',
    ann_file='data/546/annot/train.json', 
    # ann_file='data/annotations/300VW_blur_label_list_256_test_mmpose.json',

    # data_prefix=dict(img='images/'),
    data_prefix=dict(img='ESTRNN/2024_03_05_15_03_49_ESTRNN_300vw/300vw_ESTRNN_test/'),
    # data_prefix=dict(img='ESTRNN/2024_03_05_15_04_37_ESTRNN_300vw/300vw_ESTRNN_test/'),
